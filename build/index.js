...
console.log(new test_1["default"]());
var state = {
    count: 0
};
var actions = {
...
var view = function view(state, actions) {
    return hyperapp_1.h("div", null, hyperapp_1.h("h1", null, state.count), hyperapp_1.h("button", { onclick: function onclick() {
            return actions.down(1);
        } }, "-"), hyperapp_1.h("button", { onclick: function onclick() {
            return actions.up(1);
        } }, "+"));
};
